...
self.addEventListener('message', async (event: MessageEvent<WorkerRequest>) => {
  ...
  // Security Note: Additional message validation for dedicated Web Workers
  // ----------------------------------------------------------------------
  // Beyond origin verification, we perform rigorous message structure validation to ensure
